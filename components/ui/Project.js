...
const Project = () => {
    ...
    return (_jsxs("div", { className: 'h-auto w-full relative mt-10', children: [_jsx("h1", { className: 'px-10 max-sm:px-5 text-4xl', children: "My Tools \uD83D\uDCBB" }), _jsx(LogoWall, { items: logoImgs, direction: 'horizontal', pauseOnHover: true, size: 'clamp(8rem, 1rem + 20vmin, 25rem)', duration: '60s', 
                // bgColor='#060606'
